 ...
 */
public class RunningAction implements RunAction2 {
    private static final Logger LOGGER = Logger.getLogger(RunningAction.class.getName());

    /** JENKINS-37154: number of seconds to block in {@link #loadExecutions} before we give up */
    @SuppressWarnings("FieldMayBeFinal")
    private static /* not final */ int LOAD_EXECUTIONS_TIMEOUT = Integer.getInteger(RunningAction.class.getName() + ".LOAD_EXECUTIONS_TIMEOUT", 60);
